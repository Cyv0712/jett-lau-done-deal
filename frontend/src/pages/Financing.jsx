...
const Financing = () => {
  ...
  return (
    <div className="financing-page pb-5" style={{ backgroundColor: 'var(--bg-void)', minHeight: '100vh', paddingTop: '76px' }}>
      <Helmet>
        <title>Financing Inquiries | Jett Lau Done Deal</title>
        ...
        <meta property="og:title" content="Financing Inquiries | Jett Lau Done Deal" />
        <meta property="og:description" content="Get pre-approved for big bike financing with clean papers and verified inspection." />
        <meta property="og:url" content="https://jettlaudonedeal.com/financing" />
      </Helmet>
                            ...
                            <Form.Check 
                              ...
                              label={
                                <span style={{ fontSize: '0.85rem', color: '#ccc' }}>
                                  I agree to the <Link to="/privacy-policy" className="text-accent text-decoration-none">Privacy Policy</Link> and consent to Jett Lau Done Deal processing my contact details to handle my inquiry. <span className="text-accent">*</span>
                                </span>
                              }
                            />
                          </Form.Group>
