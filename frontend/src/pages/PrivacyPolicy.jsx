...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-page pb-5" style={{ backgroundColor: 'var(--bg-void)', minHeight: '100vh', paddingTop: '100px', color: '#e0e0e0' }}>
      <Helmet>
        <title>Privacy Policy | Jett Lau Done Deal</title>
        <meta name="description" content="Privacy Policy for Jett Lau Done Deal. Learn how we collect, use, and protect your data." />
      </Helmet>
        ...
        <Reveal>
          <div className="moto-card p-4 p-md-5 mx-auto" style={{ maxWidth: '800px' }}>
            ...
            <div className="content-section mb-5" style={{ fontSize: '1rem', lineHeight: '1.8' }}>
              <p>
                At Jett Lau Done Deal, we take your privacy seriously. This Privacy Policy outlines how we collect, use, and protect your personal information in compliance with data privacy regulations. By submitting an inquiry through our platform, you agree to the terms outlined below.
              </p>
              ...
              <p>
                To maximize your privacy, Jett Lau Done Deal operates with a minimal data footprint architecture:
              </p>
              <ul>
              ...
              <div className="mt-5 p-4 rounded" style={{ backgroundColor: 'rgba(212, 175, 55, 0.05)', borderLeft: '4px solid var(--accent-primary)' }}>
                ...
                <p className="mb-0 text-secondary" style={{ fontSize: '0.95rem' }}>
                  ...
                  <strong className="text-accent">Email:</strong> jettlaudonedeal@gmail.com<br/>
                  <strong className="text-accent">Phone:</strong> 09065256115
                </p>
              </div>
