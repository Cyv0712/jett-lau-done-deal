...
const LOGO_URL = 'https://jettlaudonedeal.com/static_data/jett_lau_favicon-removebg-preview.webp';
  ...
  try {
    ...
    if (resendApiKey && receiverEmail) {
      try {
        ...
        const mailOptions = {
          from: `Jett Lau Done Deal <${senderEmail}>`,
          to: recipients,
          ...
          html: `
            <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 620px; margin: 0 auto; background-color: #111111; border-radius: 12px; overflow: hidden; border: 1px solid #2a2a2a;">
              ...
              <!-- Header / Logo Banner -->
              <div style="background: linear-gradient(135deg, #1a1a1a 0%, #0d0d0d 100%); padding: 32px 40px; text-align: center; border-bottom: 2px solid #FF1E27;">
                <img src="${LOGO_URL}" alt="Jett Lau Done Deal" style="max-height: 90px; max-width: 280px; object-fit: contain; display: block; margin: 0 auto 12px auto;" />
              ...
              <div style="padding: 36px 40px;">
                ...
                <p style="margin: 0 0 28px 0; font-size: 14px; color: #888888; line-height: 1.6;">A potential client has submitted a financing inquiry through the Jett Lau Done Deal website. Their details are listed below.</p>
                ...
                <table style="width: 100%; border-collapse: collapse; border-radius: 8px; overflow: hidden;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 14px 16px; background-color: #161616; border-bottom: 1px solid #222; font-size: 15px; color: #FF1E27; font-weight: 700;">${unitInterested}</td>
                  </tr>
                  <tr>
                ...
                <!-- CTA Note -->
                <div style="margin-top: 28px; padding: 16px 20px; background-color: #1a0505; border-left: 3px solid #FF1E27; border-radius: 4px;">
        ...
        console.log(`[Resend] Inquiry email successfully dispatched to ${recipients.join(', ')}. ID: ${emailResult.id}`);
      } catch (mailErr) {
